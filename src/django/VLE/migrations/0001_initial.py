# Generated by Django 2.1 on 2018-09-18 21:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points_possible', models.IntegerField(blank=True, null=True, verbose_name='points_possible')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.TextField(choices=[('t', 'text'), ('rt', 'rich text'), ('i', 'img'), ('p', 'pdf'), ('f', 'file'), ('v', 'vid'), ('u', 'url')], default='t', max_length=4)),
