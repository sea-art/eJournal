...
class User(AbstractUser):
    ...
    def can_view(self, obj):
        if isinstance(obj, Journal):
            if obj.user != self:
                return self.has_permission('can_view_journals', obj.assignment)
            else:
...
class Role(models.Model):
    ...
    can_view_journals = models.BooleanField(default=False)
