...
def make_role_default_no_perms(name, course, can_edit_course_details=False, can_delete_course=False,
                               ...
                               can_view_all_assignment_journals=False, can_grade=False, can_publish_grades=False,
    ...
    role = Role(
        ...
        can_view_all_assignment_journals=can_view_all_assignment_journals,
        can_grade=can_grade,
...
def make_role_default_all_perms(name, course, can_edit_course_details=True, can_delete_course=True,
                                ...
                                can_view_all_assignment_journals=True, can_grade=True, can_publish_grades=True,
    ...
    return make_role_default_no_perms(name, course, can_edit_course_details, can_delete_course, can_edit_course_roles,
                                      ...
                                      can_edit_assignment, can_view_all_assignment_journals, can_grade,
