...
urlpatterns = [
    ...
    path('api/get_unenrolled_users/<int:cID>/', get_unenrolled_users, name='get_unenrolled_users'),
    ...
    path('api/update_course_with_studentID/', update_course_with_studentID, name='update_course_with_studentID'),
