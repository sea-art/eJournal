...
urlpatterns = [
    ...
    path('get_entrycomments/<int:entryID>/', get.get_entrycomments, name='get_entrycomments'),
    ...
    path('update_publish_grade_entry/<int:eID>/', update.update_publish_grade_entry, name='update_grade_entry'),
    path('update_publish_grades_assignment/<int:aID>/', update.update_publish_grades_assignment,
         name='update_publish_grades_assignment'),
    path('update_publish_grades_journal/<int:jID>/', update.update_publish_grades_journal,
