...
def set_up_user_and_auth(username, password, is_admin=False, is_teacher=False):
    ...
    """
    user = factory.make_user(username, password, is_admin=is_admin, is_teacher=is_teacher)
