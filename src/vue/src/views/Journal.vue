<template>
    <b-row no-gutters>
        <b-col v-if="bootstrapLg()" cols="12">
            <!-- <bread-crumb v-if="bootstrapLg()" @eye-click="customisePage" :currentPage="$route.params.assignmentName" :course="$route.params.courseName" :assign="$route.params.assignmentName"/> -->
        ...
        <b-col lg="12" xl="6" order="2" class="main-content">
            <bread-crumb v-if="bootstrapLg()" @eye-click="customisePage" :currentPage="$route.params.assignmentName + ' Journal'"/>
            <bread-crumb :currentPage="$route.params.assignmentName + ' Journal'"/>
