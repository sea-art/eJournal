<template>
    <journal-non-student v-if="$hasPermission('can_grade')" :cID="cID" :aID="aID" :jID="jID"/>
    <journal-student v-else-if="$hasPermission('can_have_journal')" :cID="cID" :aID="aID" :jID="jID"/>
</template>
